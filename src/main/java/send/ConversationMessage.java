...
public class ConversationMessage {
    ...
    public static String newUserInfoTOAdmin(WebhookPushData webhookPushData, FbUserProfile fbUserProfile) {
        ...
        doneQuickReply.setPayload("ADMIN_MESSAGE:REGISTRATION:SUCCESS:SEND_MESSAGE:" + messageEntry.getSender().get("id") + "");

        QuickReply wrongInfoQuickReply = new QuickReply("text", "WrongInfo");
        wrongInfoQuickReply.setPayload("ADMIN_MESSAGE:REGISTRATION:FAILURE:NONE:" + messageEntry.getSender().get("id") + "");
